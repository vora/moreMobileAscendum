...
public class PrepaidCardReloadPage extends MoreMobileAbstractBasePage {
    ...
    @FindBy(xpath="//h1[contains(text(),'Auto Reload')]")
    private WebElement autoReloadText;
   ...
   // @FindBy(id = "agreement")
    @FindBy(xpath="//input[@type='checkbox'][@id='agreement']")
    //@FindBy(xpath = "//div[@class='styles__StyledCheckbox-sc-6jchgp-3 dlvgUA']")
    private WebElement addressCheckBox;

    @FindBy(xpath = "//div[@class='styles__StyledCheckbox-sc-6jchgp-3 gJfJPF']")
    private WebElement uncheckAddressCheckBox;
    ...
    public WebElement getWebElement(String elementName) {
        ...
        switch (elementName) {
            ...
            case "auto reload text":
                webElement = autoReloadText;
                break;
            ...
            case "uncheck address check box":
                webElement = uncheckAddressCheckBox;
                break;
